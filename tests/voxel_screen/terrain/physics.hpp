...
namespace hemlock {
    namespace test {
        namespace voxel_screen {
            ...
            public:
                VoxelPhysDrawer(
                    hcam::BasicFirstPersonCamera* camera, hg::GLSLProgram* shader
                ) :
                    btIDebugDraw() {
                    m_camera      = camera;
                    ...
                    glNamedBufferData(
                        m_vbo, sizeof(f32v3) * 2, nullptr, GL_DYNAMIC_DRAW
                    );
                ...
                virtual void
                drawLine(const btVector3& from, const btVector3& to, const btVector3&)
                    override {
                    f32v3 points[2] = {
                    ...
                    glUniform3fv(
                        m_line_shader->uniform_location("colour"), 1, &_colour[0]
                    );
                ...
                virtual void
                draw3dText(const btVector3&, const char*) override { /* Empty. */
                }
