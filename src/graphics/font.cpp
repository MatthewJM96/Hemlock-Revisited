...
namespace hemlock {
    namespace graphics {
        ...
        bool FontInstance::save(const char* filepath, hio::image::Saver save) {
        ...
        void Font::init(const char* filepath, char start, char end) {
            m_filepath = filepath;
            m_start    = start;
            m_end      = end;
        }
        ...
        bool Font::generate( FontSize size,
                             FontSize padding,
        ...
        FontInstance Font::getFontInstance(  FontSize size,
                                            FontStyle style       /*= FontStyle::NORMAL*/,
                                      FontRenderStyle renderStyle /*= FontRenderStyle::BLENDED*/ ) {
            try {
        ...
        Font::Row* Font::generateRows(Glyph* glyphs, ui32 rowCount, FontSize padding, ui32& width, ui32& height) {
        ...
        bool FontCache::registerFont(const char* name, const char* filepath, char start, char end) {
        ...
        bool FontCache::registerFont(const char* name, const char* filepath) {
        ...
        FontInstance FontCache::fetchFontInstance( const char* name,
                                                      FontSize size,
                                                     FontStyle style /*= FontStyle::NORMAL*/,
                                               FontRenderStyle renderStyle /*= FontRenderStyle::BLENDED*/) {
