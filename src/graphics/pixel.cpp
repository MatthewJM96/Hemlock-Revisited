...
bool hg::p::convert_sdl_indexed_to_rgba_8888(SDL_Surface* sdl_surface, ui8*& pixel_buffer) {
...
bool hg::p::convert_sdl_xxxx_8888_to_rgba_8888(SDL_Surface* sdl_surface, ui8*& pixel_buffer) {
    if (sdl_surface == nullptr) return false;
