    ...
    namespace camera {
        ...
        public:
            ...
            void attach_to_window(app::WindowBase* window);
                  ...
                  f32v2  nf_clipping()            const { return { m_state.near_clipping, m_state.far_clipping };   }
            ...
            const f32m4& view_projection_matrix() const { return m_state.view_projection_matrix;                    }
