...
#    define H_SERIALISABLE_VENUM_ENTRY(ENTRY)       \
H_VENUM_NAME ENTRY
#  endif //!defined(H_SERIALISABLE_ENUM_ENTRY)
...
namespace hemlock {                                                                                         \
    namespace io {                                                                                          \
        [[maybe_unused]] static const std::unordered_map<std::string, NAMESPACE :: NAME> NAME##_Values = {  \
...
#    define H_VENUM_MAP_ENTRY(NAMESPACE, ENTRY) { H_VENUM_NAME_STR ENTRY, NAMESPACE :: H_VENUM_NAME ENTRY }
