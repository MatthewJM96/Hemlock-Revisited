        ...
        namespace fs {
            namespace glob {
                namespace impl {
                     ...
                     */
                    void handle_all_file_match(paths& builder);
                     ...
                     * @param builder The builder to process.
                     */
                    void handle_recursive_directory_match(paths& builder);
                     ...
                     */
                    bool contains_glob_char(const path& part);
                     ...
                     */
                    void handle_partial_glob(const path& part, paths& builder);
                }
                 ...
                 */
                paths glob(const path& globpath, bool recursive = false);
            }
        }
    }
}
