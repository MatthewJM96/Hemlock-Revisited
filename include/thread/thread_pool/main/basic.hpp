#ifndef __hemlock_thread_thread_pool_main_basic_hpp
#define __hemlock_thread_thread_pool_main_basic_hpp
...
namespace hemlock {
    namespace thread {
        ...
        void basic_thread_main(ThreadState* state, TaskQueue* task_queue) {
            ...
            while (!state->stop) {
                auto queue_task = task_queue->dequeue(current_task, std::chrono::microseconds(100));
...
#endif  // __hemlock_thread_thread_pool_main_basic_hpp
