#ifndef __hemlock_thread_thread_pool_timed_hpp
#define __hemlock_thread_thread_pool_timed_hpp

#include "thread/state.hpp"
#include "thread/task.hpp"
#include "thread/queue/basic.hpp"
#include "thread/thread_pool/main/timed.hpp"

namespace hemlock {
    namespace thread {
        template <IsTimedTaskQueue TaskQueue = TimedBasicTaskQueue>
        ...
        public:
            ...
            void init(
                ...
                = ThreadMainFunc<TaskQueue>{ timed_thread_main<TaskQueue> }
            );
            /**
...
#include "thread/thread_pool/timed.inl"

#endif  // __hemlock_thread_thread_pool_timed_hpp
