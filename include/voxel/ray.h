...
namespace hemlock {
    namespace voxel {
        ...
        namespace Ray {
             ...
             * @brief Steps the ray along its direction until the
             * first block that is exactly the specified target block.
             * The position and distance are set to the block the ray
             * was incident on before that block.
             *
             * @param start The location the ray starts at.
             * @param direction The normalised direction to cast the ray in.
             * @param grid_handle Handle to the chunk grid in which the ray is cast.
             ...
             * @brief Steps the ray along its direction until the
             * first block that satisfies the conditions encoded by
             * block_is_target. The position and distance are set to
             * the block the ray was incident on before that block.
             *
             * @param start The location the ray starts at.
             * @param direction The normalised direction to cast the ray in.
             * @param grid_handle Handle to the chunk grid in which the ray is cast.
