    ...
    namespace voxel {
        namespace Ray {
            namespace impl {
                 ...
                 */
                f32 min_coeff_to_int(f32 s, f32 ds) {
...
bool hvox::Ray::cast_to_block(
    ...
    BlockWorldPosition step  = BlockWorldPosition{ impl::sign(direction.x),
                                                  impl::sign(direction.y),
                                                  impl::sign(direction.z) };
    f32v3              delta = f32v3{
        static_cast<f32>(step.x) / direction.x,
        static_cast<f32>(step.y) / direction.y,
        static_cast<f32>(step.z) / direction.z,
    };
    f32v3 steps_to_next = f32v3{ impl::min_coeff_to_int(start.x, direction.x),
                                 impl::min_coeff_to_int(start.y, direction.y),
                                 impl::min_coeff_to_int(start.z, direction.z) };
    ...
    do {
        impl::step_to_next_block_position(
