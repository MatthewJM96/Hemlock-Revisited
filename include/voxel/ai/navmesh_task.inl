...
void hvox::ChunkNavmeshTask<IsSolid>::execute(
...

    {
            ...
            ))
        {
                                ...
                                && !is_solid(left_of_neighbour_block))
                            {
                                ...
                                try {
                                    ...
                                    left_of_and_below_this_block_vertex
                                        = boost::add_vertex(chunk->navmesh.graph);
                                    chunk->navmesh
                                        .coord_vertex_map[left_of_and_below_this_block_coord]
                                        = left_of_and_below_this_block_vertex;
                                }
                                ...
                                && !is_solid(right_of_neighbour_block))
                            {
                                ...
                                try {
                                    ...
                                    right_of_and_below_this_block_vertex
                                        = boost::add_vertex(chunk->navmesh.graph);
                                    chunk->navmesh
                                        .coord_vertex_map[right_of_and_below_this_block_coord]
                                        = right_of_and_below_this_block_vertex;
                                }
                                ...
                                && !is_solid(front_of_neighbour_block))
                            {
                                ...
                                try {
                                    ...
                                    front_of_and_below_this_block_vertex
                                        = boost::add_vertex(chunk->navmesh.graph);
                                    chunk->navmesh
                                        .coord_vertex_map[front_of_and_below_this_block_coord]
                                        = front_of_and_below_this_block_vertex;
                                }
                                ...
                                && !is_solid(back_of_neighbour_block))
                            {
                                ...
                                try {
                                    ...
                                    back_of_and_below_this_block_vertex
                                        = boost::add_vertex(chunk->navmesh.graph);
                                    chunk->navmesh
                                        .coord_vertex_map[back_of_and_below_this_block_coord]
                                        = back_of_and_below_this_block_vertex;
                                }
            ...
            // Check step up from top layer of chunk to each adjacent neighbour of above chunk.
            ...
            // Left
            {
                    ...
                    ))
                {
                    ...
                    for (BlockChunkPositionCoord z = 0; z < CHUNK_LENGTH; ++z) {
                        BlockIndex left_of_neighbour_block_index
                            = hvox::block_index({ CHUNK_LENGTH - 1, 0, z });
                        Block* left_of_neighbour_block = &left_of_neighbour->blocks[left_of_neighbour_block_index];

                        BlockIndex above_left_of_neighbour_block_index
                            = hvox::block_index({ CHUNK_LENGTH - 1, 1, z });
                        Block* above_left_of_neighbour_block = &left_of_neighbour->blocks[above_left_of_neighbour_block_index];

                        if (!is_solid(left_of_neighbour_block) || is_solid(above_left_of_neighbour_block)) continue;
                        ...
                        try {
                            left_of_neighbour_block_vertex.here
                                = chunk->navmesh.coord_vertex_map.at(left_of_neighbour_block_coord);
                        } catch (std::out_of_range) {
                            left_of_neighbour_block_vertex.here
                                = boost::add_vertex(chunk->navmesh.graph);
                            chunk->navmesh.coord_vertex_map[left_of_neighbour_block_coord]
                                = left_of_neighbour_block_vertex.here;
                        }
                        ...
                        try {
                            ...
                            left_of_neighbour->navmesh.coord_vertex_map[left_of_neighbour_block_coord]
                                = left_of_neighbour_block_vertex.in_left_of_neighbour;
                        }
            ...
            // Right
            {
                ...
                if (right_of_neighbour != nullptr
                    && right_of_neighbour->bulk_navmeshing.load() == ChunkState::COMPLETE
                    ...
                    ))
                {
                    ...
                    for (BlockChunkPositionCoord z = 0; z < CHUNK_LENGTH; ++z) {
                        ...
                        Block* right_of_neighbour_block = &right_of_neighbour->blocks[right_of_neighbour_block_index];

                        BlockIndex above_right_of_neighbour_block_index
                            = hvox::block_index({ 0, 1, z });
                        Block* above_right_of_neighbour_block = &right_of_neighbour->blocks[above_right_of_neighbour_block_index];

                        if (!is_solid(right_of_neighbour_block) || is_solid(above_right_of_neighbour_block)) continue;
                        ...
                        try {
                            right_of_neighbour_block_vertex.here
                                = chunk->navmesh.coord_vertex_map.at(right_of_neighbour_block_coord);
                        } catch (std::out_of_range) {
                            right_of_neighbour_block_vertex.here
                                = boost::add_vertex(chunk->navmesh.graph);
                            chunk->navmesh.coord_vertex_map[right_of_neighbour_block_coord]
                                = right_of_neighbour_block_vertex.here;
                        }
                        ...
                        try {
                            ...
                            right_of_neighbour->navmesh.coord_vertex_map[right_of_neighbour_block_coord]
                                = right_of_neighbour_block_vertex.in_right_of_neighbour;
                        }
                        ...
                        BlockIndex above_candidate_index = hvox::block_index({ CHUNK_LENGTH - 1, 0, z });
                        Block*     above_candidate_block
                            = &neighbour->blocks[above_candidate_index];
            ...
            // Front
            {
                ...
                if (front_of_neighbour != nullptr
                    && front_of_neighbour->bulk_navmeshing.load() == ChunkState::COMPLETE
                    ...
                    ))
                {
                    ...
                    for (BlockChunkPositionCoord x = 0; x < CHUNK_LENGTH; ++x) {
                        ...
                        Block* front_of_neighbour_block = &front_of_neighbour->blocks[front_of_neighbour_block_index];

                        BlockIndex above_front_of_neighbour_block_index
                            = hvox::block_index({ x, 1, 0 });
                        Block* above_front_of_neighbour_block = &front_of_neighbour->blocks[above_front_of_neighbour_block_index];

                        if (!is_solid(front_of_neighbour_block) || is_solid(above_front_of_neighbour_block)) continue;
                        ...
                        try {
                            front_of_neighbour_block_vertex.here
                                = chunk->navmesh.coord_vertex_map.at(front_of_neighbour_block_coord);
                        } catch (std::out_of_range) {
                            front_of_neighbour_block_vertex.here
                                = boost::add_vertex(chunk->navmesh.graph);
                            chunk->navmesh.coord_vertex_map[front_of_neighbour_block_coord]
                                = front_of_neighbour_block_vertex.here;
                        }
                        ...
                        try {
                            ...
                            front_of_neighbour->navmesh.coord_vertex_map[front_of_neighbour_block_coord]
                                = front_of_neighbour_block_vertex.in_front_of_neighbour;
                        }
                        ...
                        BlockIndex above_candidate_index = hvox::block_index({ x, 0, CHUNK_LENGTH - 1 });
                        Block*     above_candidate_block
                            = &neighbour->blocks[above_candidate_index];
            ...
            // Back
            {
                    ...
                    ))
                {
                    ...
                    for (BlockChunkPositionCoord x = 0; x < CHUNK_LENGTH; ++x) {
                        BlockIndex back_of_neighbour_block_index
                            = hvox::block_index({ x, 0, CHUNK_LENGTH - 1 });
                        Block* back_of_neighbour_block = &back_of_neighbour->blocks[back_of_neighbour_block_index];

                        BlockIndex above_back_of_neighbour_block_index
                            = hvox::block_index({ x, 1, CHUNK_LENGTH - 1 });
                        Block* above_back_of_neighbour_block = &back_of_neighbour->blocks[above_back_of_neighbour_block_index];

                        if (!is_solid(back_of_neighbour_block) || is_solid(above_back_of_neighbour_block)) continue;
                        ...
                        try {
                            back_of_neighbour_block_vertex.here
                                = chunk->navmesh.coord_vertex_map.at(back_of_neighbour_block_coord);
                        } catch (std::out_of_range) {
                            back_of_neighbour_block_vertex.here
                                = boost::add_vertex(chunk->navmesh.graph);
                            chunk->navmesh.coord_vertex_map[back_of_neighbour_block_coord]
                                = back_of_neighbour_block_vertex.here;
                        }
                        ...
                        try {
                            ...
                            back_of_neighbour->navmesh.coord_vertex_map[back_of_neighbour_block_coord]
                                = back_of_neighbour_block_vertex.in_back_of_neighbour;
                        }
            ...
            // Check step up from second-to-top layer of chunk to each adjacent neighbour of above chunk,
            // and check step across and down from top layer of chunk to each adjacent neighbour of this and above chunk.
            ...
            // Left
            {
                ...
                if (left_neighbour != nullptr
                    && above_left_neighbour != nullptr
                    && left_neighbour->bulk_navmeshing.load() == ChunkState::COMPLETE
                    && above_left_neighbour->bulk_navmeshing.load() == ChunkState::COMPLETE
                    && chunk->navmesh_stitch.above_and_across_left.compare_exchange_strong(
                        left_of_neighbour_stitch_state, ChunkState::ACTIVE
                    ))
                {
                    ...
                    for (BlockChunkPositionCoord z = 0; z < CHUNK_LENGTH; ++z) {
                        ...
                        BlockIndex twice_above_this_block_index
                            = hvox::block_index({ 0, 0, z });
                        Block* twice_above_this_block = &neighbour->blocks[twice_above_this_block_index];

                        if (!is_solid(this_block) || is_solid(above_this_block) || is_solid(twice_above_this_block)) continue;
                        ...
                        BlockIndex above_candidate_index = hvox::block_index({ CHUNK_LENGTH - 1, 0, z });
                        Block*     above_candidate_block = &above_left_neighbour->blocks[above_candidate_index];

                        BlockIndex candidate_index = hvox::block_index({ CHUNK_LENGTH - 1, CHUNK_LENGTH - 1, z });
                        Block* candidate_block     = &left_neighbour->blocks[candidate_index];

                        if (!is_solid(candidate_block) || is_solid(above_candidate_block)) continue;
                    ...
                    chunk->navmesh_stitch.above_and_across_left.store(ChunkState::COMPLETE);
                }
            }
            ...
            // Right
            {
                ...
                if (right_neighbour != nullptr
                    && above_right_neighbour != nullptr
                    && right_neighbour->bulk_navmeshing.load() == ChunkState::COMPLETE
                    && above_right_neighbour->bulk_navmeshing.load() == ChunkState::COMPLETE
                    && chunk->navmesh_stitch.above_and_across_right.compare_exchange_strong(
                        right_of_neighbour_stitch_state, ChunkState::ACTIVE
                    ))
                {
                    ...
                    for (BlockChunkPositionCoord z = 0; z < CHUNK_LENGTH; ++z) {
                        ...
                        BlockIndex above_candidate_index = hvox::block_index({ 0, 0, z });
                        Block*     above_candidate_block = &above_right_neighbour->blocks[above_candidate_index];

                        BlockIndex candidate_index = hvox::block_index({ 0, CHUNK_LENGTH - 1, z });
                        Block* candidate_block     = &right_neighbour->blocks[candidate_index];
                    ...
                    chunk->navmesh_stitch.above_and_across_right.store(ChunkState::COMPLETE);
                }
            }
            ...
            // Front
            {
                ...
                if (front_neighbour != nullptr
                    && above_front_neighbour != nullptr
                    && front_neighbour->bulk_navmeshing.load() == ChunkState::COMPLETE
                    && above_front_neighbour->bulk_navmeshing.load() == ChunkState::COMPLETE
                    && chunk->navmesh_stitch.above_and_across_front.compare_exchange_strong(
                        front_of_neighbour_stitch_state, ChunkState::ACTIVE
                    ))
                {
                    ...
                    for (BlockChunkPositionCoord x = 0; x < CHUNK_LENGTH; ++x) {
                        ...
                        BlockIndex above_candidate_index = hvox::block_index({ x, 0, 0 });
                        Block*     above_candidate_block = &above_front_neighbour->blocks[above_candidate_index];

                        BlockIndex candidate_index = hvox::block_index({ x, CHUNK_LENGTH - 1, 0 });
                        Block* candidate_block     = &front_neighbour->blocks[candidate_index];
                    ...
                    chunk->navmesh_stitch.above_and_across_front.store(ChunkState::COMPLETE);
                }
            }
            ...
            // Back
            {
                ...
                if (back_neighbour != nullptr
                    && above_back_neighbour != nullptr
                    && back_neighbour->bulk_navmeshing.load() == ChunkState::COMPLETE
                    && above_back_neighbour->bulk_navmeshing.load() == ChunkState::COMPLETE
                    && chunk->navmesh_stitch.above_and_across_back.compare_exchange_strong(
                        back_of_neighbour_stitch_state, ChunkState::ACTIVE
                    ))
                {
                    ...
                    for (BlockChunkPositionCoord x = 0; x < CHUNK_LENGTH; ++x) {
                        ...
                        BlockIndex above_candidate_index = hvox::block_index({ x, 0, CHUNK_LENGTH - 1 });
                        Block*     above_candidate_block = &above_back_neighbour->blocks[above_candidate_index];

                        BlockIndex candidate_index = hvox::block_index({ x, CHUNK_LENGTH - 1, CHUNK_LENGTH - 1 });
                        Block* candidate_block     = &back_neighbour->blocks[candidate_index];
                    ...
                    chunk->navmesh_stitch.above_and_across_back.store(ChunkState::COMPLETE);
                }
            }
        }
    }
...

    {
            ...
            ))
        {
            ...
            for (BlockChunkPositionCoord x = 1; x < CHUNK_LENGTH - 1; ++x) {
                for (BlockChunkPositionCoord z = 1; z < CHUNK_LENGTH - 1; ++z) {
                    BlockIndex this_block_index
                        = hvox::block_index({ x, 0, z });
                    Block* this_block = &chunk->blocks[this_block_index];

                    BlockIndex above_this_index
                        = hvox::block_index({ x, 1, z });
                    Block* above_neighbour_block
                        = &neighbour->blocks[above_neighbour_block_index];

                    BlockIndex neighbour_block_index = hvox::block_index({ x, CHUNK_LENGTH - 1, z });
                    Block* neighbour_block = &neighbour->blocks[neighbour_block_index];
                    ...
                    if (is_solid(neighbour_block) && !is_solid(this_block)) {
                        ...
                        // Across and Down
                            ...
                            BlockIndex left_of_neighbour_block_index
                                = hvox::block_index({ x - 1, CHUNK_LENGTH - 1, z });
                            Block* left_of_neighbour_block = &neighbour->blocks[left_of_neighbour_block_index];

                            BlockIndex left_of_and_below_neighbour_block_index
                                = hvox::block_index({ x - 1, CHUNK_LENGTH - 2, z });
                            Block* left_of_and_below_neighbour_block = &neighbour->blocks[left_of_and_below_neighbour_block_index];
                            ...
                            // Down
                            } else if (is_solid(left_of_and_below_neighbour_block)
                                && !is_solid(left_of_neighbour_block)
                                && !is_solid(left_of_this_block))
                            {
                                ...
                                // Ensure node exists for this block.
                                ChunkNavmeshVertexDescriptor left_of_and_below_neighbour_block_vertex = {};
                            ...
                            BlockIndex right_of_neighbour_block_index
                                = hvox::block_index({ x + 1, CHUNK_LENGTH - 1, z });
                            Block* right_of_neighbour_block = &neighbour->blocks[right_of_neighbour_block_index];

                            BlockIndex right_of_and_below_neighbour_block_index
                                = hvox::block_index({ x + 1, CHUNK_LENGTH - 2, z });
                            Block* right_of_and_below_neighbour_block = &neighbour->blocks[right_of_and_below_neighbour_block_index];
                            ...
                            // Down
                            } else if (is_solid(right_of_and_below_neighbour_block)
                                && !is_solid(right_of_neighbour_block)
                                && !is_solid(right_of_this_block))
                            {
                                ...
                                // Ensure node exists for this block.
                                ChunkNavmeshVertexDescriptor right_of_and_below_neighbour_block_vertex = {};
                            ...
                            BlockIndex front_of_neighbour_block_index
                                = hvox::block_index({ x, CHUNK_LENGTH - 1, z + 1 });
                            Block* front_of_neighbour_block = &neighbour->blocks[front_of_neighbour_block_index];

                            BlockIndex front_of_and_below_neighbour_block_index
                                = hvox::block_index({ x, CHUNK_LENGTH - 2, z + 1 });
                            Block* front_of_and_below_neighbour_block = &neighbour->blocks[front_of_and_below_neighbour_block_index];
                            ...
                            // Down
                            } else if (is_solid(front_of_and_below_neighbour_block)
                                && !is_solid(front_of_neighbour_block)
                                && !is_solid(front_of_this_block))
                            {
                                ...
                                // Ensure node exists for this block.
                                ChunkNavmeshVertexDescriptor front_of_and_below_neighbour_block_vertex = {};
                            ...
                            BlockIndex back_of_neighbour_block_index
                                = hvox::block_index({ x, CHUNK_LENGTH - 1, z - 1 });
                            Block* back_of_neighbour_block = &neighbour->blocks[back_of_neighbour_block_index];

                            BlockIndex back_of_and_below_neighbour_block_index
                                = hvox::block_index({ x, CHUNK_LENGTH - 2, z - 1 });
                            Block* back_of_and_below_neighbour_block = &neighbour->blocks[back_of_and_below_neighbour_block_index];
                            ...
                            // Down
                            } else if (is_solid(back_of_and_below_neighbour_block)
                                && !is_solid(back_of_neighbour_block)
                                && !is_solid(back_of_this_block))
                            {
                                ...
                                // Ensure node exists for this block.
                                ChunkNavmeshVertexDescriptor back_of_and_below_neighbour_block_vertex = {};
