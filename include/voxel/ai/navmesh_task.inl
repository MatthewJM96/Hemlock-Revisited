...
void hvox::ChunkNavmeshTask<IsSolid>::execute(
    ...
    for (BlockChunkPositionCoord z = 1; z < CHUNK_LENGTH - 1; ++z) {
        ...
        // Second-to-top case.
        {
            ...
            // Right Face
            {
                ...
                // Left
                do_navigable_check(
                    block_vertex, { CHUNK_LENGTH - 2, CHUNK_LENGTH - 2, z }, 1, -1
                );

                // Front
                do_navigable_check(
                    block_vertex, { CHUNK_LENGTH - 1, CHUNK_LENGTH - 2, z + 1 }, 1, -1
                );
    ...
    for (BlockChunkPositionCoord x = 1; x < CHUNK_LENGTH - 1; ++x) {
        ...
        // Second-to-top case
        {
            // Front Face
            {
                ...
                // Left
                do_navigable_check(
                    block_vertex, { x - 1, CHUNK_LENGTH - 2, CHUNK_LENGTH - 1 }, 1, -1
                );
                ...
                // Back
                do_navigable_check(
                    block_vertex, { x, CHUNK_LENGTH - 2, CHUNK_LENGTH - 2 }, 1, -1
                );
            }
    ...
    for (BlockChunkPositionCoord y = 1; y < CHUNK_LENGTH - 2; ++y) {
        ...
        // Front-Right Edge
        {
            ...
            // Left
            do_navigable_check(
                block_vertex, { CHUNK_LENGTH - 2, y, CHUNK_LENGTH - 1 }, 2, -1
            );

            // Back
            do_navigable_check(
                block_vertex, { CHUNK_LENGTH - 1, y, CHUNK_LENGTH - 2 }, 2, -1
            );
        }
    ...
    // Front-Left Edge
    {
        ...
        if (is_solid(block) && !is_solid(block_above)) {
            ...
            // Right
            do_navigable_check(
                block_vertex, { 1, CHUNK_LENGTH - 2, CHUNK_LENGTH - 1 }, 1, -1
            );

            // Back
            do_navigable_check(
                block_vertex, { 0, CHUNK_LENGTH - 2, CHUNK_LENGTH - 2 }, 1, -1
            );
        }
    }
    ...
    // Back-Right Edge
    {
        ...
        if (is_solid(block) && !is_solid(block_above)) {
            ...
            // Left
            do_navigable_check(
                block_vertex, { CHUNK_LENGTH - 2, CHUNK_LENGTH - 2, 0 }, 1, -1
            );

            // Front
            do_navigable_check(
                block_vertex, { CHUNK_LENGTH - 1, CHUNK_LENGTH - 2, 1 }, 1, -1
            );
        }
    }
    ...
    // Right-Bottom-Front
    {
        ...
        if (is_solid(block) && !is_solid(block_above)) {
            ...
            // Left
            do_navigable_check(
                block_vertex, { CHUNK_LENGTH - 2, 0, CHUNK_LENGTH - 1 }, 2, 0
            );

            // Back
            do_navigable_check(
                block_vertex, { CHUNK_LENGTH - 1, 0, CHUNK_LENGTH - 2 }, 2, 0
            );
        }
    }
    // Right-Bottom-Back
