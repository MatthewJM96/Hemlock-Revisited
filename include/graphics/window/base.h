#ifndef __hemlock_graphics_window_base_h
#define __hemlock_graphics_window_base_h
...
namespace hemlock {
    namespace graphics {
        ...
        public:
            ...
            virtual void set_allowed_resolutions (WindowDimensionMap allowed_resolutions) = 0;
...
#endif // __hemlock_graphics_window_base_h
