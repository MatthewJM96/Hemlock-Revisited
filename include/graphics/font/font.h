...
namespace hemlock {
    namespace graphics {
        namespace font {
            ...
            //                    At one level this can be done inside Font by
            //                    generating multiple font instances simultaneously in
            //                    a pack, at a second, we could let the cacher request
            //                    all the font instances it has cached be packed
            //                    together?
            //                        Packing the fonts will reduce the number of
            //                        drawcalls needed in text using multiple font
            //                        instances (e.g. bold and non-bold text)
            /**
             * @brief Handles a single font (defined by a single TTF file), for which
             * textures may be generated for variations of font size and style.
             */
            class Font {
                using FontInstanceMap
                    = std::unordered_map<FontInstanceHash, FontInstance>;
            public:
                ...
                /**
                 * @brief Initialises the font, after which it is ready to generate
                 * glyphs of specified sizes and styles.
                 *
                 ...
                 * glyphs of specified sizes and styles.
                 *
                 * This version uses a default value for the first and final
                 * characters to generate glyphs for. These characters are the
                 * printable characters in (non-extended) ASCII except for char 127.
                 *
                 * @param filepath The path to the font's TTF file.
                 */
                ...
                /**
                 * @brief Disposes of the font and all variations for which textures
                 * were generated.
                 */
                void dispose();
                ...
                /**
                 * @brief Generates a texture atlas of glyphs with the given render
                 * style, font style and font size.
                 *
                 * Note that all textures are of white glyphs, use shaders to tint
                 * them!
                 *
                 ...
                 * @param render_style The style with which the font should be
                 * rendered.
                 *
                 * @return True if a font instance was created, false indicates the
                 * font instance with the given properties already existed.
                 */
                bool generate(
                    FontSize        size,
                    FontSize        padding,
                 ...
                 * them!
                 *
                 * This variation makes a reasonable guess at a padding to use between
                 * glyphs; in most cases it should not be necessary to specify a
                 * different padding.
                 *
                 * @param size The size of the glyphs to be drawn.
                 * @param style The style of the font itself.
                ...
                /**
                 * @brief Generates a texture atlas of glyphs with the default render
                 * style, font style and font size.
                 *
                 * Note that all textures are of white glyphs, use shaders to tint
                 * them!
                ...
                /**
                 * @brief Returns the font instance corresponding to the given size,
                 * style and render style.
                 *
                 * @param size The font size.
                 * @param style The font style.
                 * @param render_style The font render style.
                 *
                 * @return The font instance corresponding to the given size, style
                 * and render style, or NIL_FONT_INSTANCE if no font instance exists
                 * with the given
                 */
                FontInstance get_instance(
                    FontSize        size,
                    FontStyle       style        = FontStyle::NORMAL,
                    FontRenderStyle render_style = FontRenderStyle::BLENDED
                );
                 ...
                 *
                 * @return True if a font instance was found and disposed, false
                 * otherwise.
                 */
                ...
                /**
                 * @brief Disposes the font instance corresponding to the given size,
                 * style and render style.
                 *
                 * @param size The font size.
                 * @param style The font style.
            ...
            protected:
                 ...
                 * @param height This is set to the sum of the max height of each
                 * glyph in each row.
                 */
                Row* generate_rows(
                    Glyph*   glyphs,
            ...
            class FontCache :
                public hio::Cache<Font, std::unordered_map<std::string, Font>> { };
        }  // namespace font
        namespace f = font;
    }  // namespace graphics
}  // namespace hemlock
