...
#define MAKE_NORMAL2D(PRECISION)    (Vertex_Normal2D_##PRECISION,   normal,     NORMAL,     2,  PRECISION,  0)
#define MAKE_NORMAL3D(PRECISION)    (Vertex_Normal3D_##PRECISION,   normal,     NORMAL,     3,  PRECISION,  0)
